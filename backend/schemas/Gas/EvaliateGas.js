...
const EquipInputSchema = new mongoose.Schema(
    {
        ...
        equipInput6: {type: String, required: true},
        equipInput7: {type: String, required: true}
    },
    {_id: false}
);
...
const EvaliateGas = mongoose.model('EvaliateGas', EvaliateWaterSchema);

module.exports = EvaliateGas;
